...
import car.pubnub.api.models.consumer.PNPublishResult;
...
public class ConfigPubNub extends SubscribeCallback implements GetLocationUpdates.LocationUpdates, UpdateFrequentTask.OnTaskRunCalled {
    ...
    public void registerGcmMsgReceiver() {
        try {
            ...
            Utils.printLog("registerGcmMsgReceiver", "::" + e.toString());
    ...
    public void unRegisterGcmReceiver() {
        try {
            ...
            gcmMessageBroadCastReceiver = null;
            Utils.printLog("unRegisterGcmReceiver", "::" + e.toString());
...
//        isPubnubInstKilled = false;
    ...
    public void subscribeToPrivateChannel() {
        ...
        Utils.printLog("releaseInstancessubscribeToPrivateChannel", "::");
        try {
            pubnub.subscribe()
    ...
    public void releaseInstances() {
        try {
            ...
            Utils.printLog("releaseInstances", "::" + "called");
    ...
    public void subscribeToChannels(ArrayList<String> channels) {
         /*Facing pubnub= null issue*/

        Utils.printLog("subscribeToChannels", "::" + pubnub);
        if (pubnub != null) {
            pubnub.subscribe()
...
//        }
    ...
    public void showpopup(String Messages) {
        ...
        String iTripId = generalFunc.getJsonValue("iTripId", Messages);
