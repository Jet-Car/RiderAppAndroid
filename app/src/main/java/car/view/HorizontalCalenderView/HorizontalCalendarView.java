package car.view.HorizontalCalenderView;
...
public class HorizontalCalendarView extends RecyclerView {
    ...
    public int getPositionOfCenterItem() {
        ...
        int firstVisibilePosition = getLayoutManager().findLastVisibleItemPosition();
        Utils.printLog("firstVisibilePosition", "::" + firstVisibilePosition);
