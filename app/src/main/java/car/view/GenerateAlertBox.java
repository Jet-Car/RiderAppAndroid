...
public class GenerateAlertBox {
    ...
    public void setNeutralBtn(String neutral_btn_str) {
        alertDialogBuilder.setNeutralButton(neutral_btn_str, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {

                if (listener != null) {
                    listener.handleBtnClick(4);
                }
            }
        });
    }

    public void setPositiveBtnDrawable(Drawable drawable) {
        alertDialogBuilder.setPositiveButtonIcon(drawable);
    }

    public void setNegativeBtnDrawable(Drawable drawable) {
        alertDialogBuilder.setNegativeButtonIcon(drawable);

    }
    public void setNeutralBtnDrawable(Drawable drawable) {
        alertDialogBuilder.setNeutralButtonIcon(drawable);
