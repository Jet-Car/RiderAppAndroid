...
public class SlideDateTimePicker {
    ...
    public void setTimePickerEnabled(boolean timePickerEnabled) {
        isTimeEnabled = timePickerEnabled;
    }
    ...
    public static class Builder {
         ...
         * @see SlideDateTimePicker#setIs24HourTime(boolean)
         */
        public Builder setTimePickerEnabled(boolean isTimeEnabled) {
        ...
        public SlideDateTimePicker build() {
            ...
            picker.setTimePickerEnabled(isTimeEnabled);
