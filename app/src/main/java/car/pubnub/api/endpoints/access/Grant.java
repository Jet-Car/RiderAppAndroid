package car.pubnub.api.endpoints.access;
...
import car.pubnub.api.models.consumer.access_manager.PNAccessManagerGrantResult;
import car.pubnub.api.models.consumer.access_manager.PNAccessManagerKeyData;
import car.pubnub.api.models.server.Envelope;
import car.pubnub.api.models.server.access_manager.AccessManagerGrantPayload;
...
public class Grant extends Endpoint<Envelope<AccessManagerGrantPayload>, PNAccessManagerGrantResult> {
    ...
    public Grant read(final boolean read) {
        this.read = read;
        return this;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Grant write(final boolean write) {
        this.write = write;
        return this;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Grant manage(final boolean manage) {
        this.manage = manage;
        return this;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Grant ttl(final Integer ttl) {
        this.ttl = ttl;
        return this;
    }
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Grant authKeys(final List<String> authKeys) {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Grant channels(final List<String> channels) {
    ...
    @java.lang.SuppressWarnings("all")
    @javax.annotation.Generated("lombok")
    public Grant channelGroups(final List<String> channelGroups) {
