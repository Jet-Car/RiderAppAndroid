...
public class CommonUtilities {
    ...
    public static final String MINT_APP_ID = "a47abce5";
    public static final String package_name = "car.jet.riderapp";

    public static final String TOLLURL = "https://tce.cit.api.here.com/2/calculateroute.json?app_id=";

//    public static final String SERVER = "http://www.mobileappsdemo.com/projects/jet/";
//    public static final String SERVER = "https://www.jet.car/";
//    public static final String SERVER = "http://192.168.1.131/jet/";

    public static final String SERVER_FOLDER_PATH = "";
    public static final String SERVER = "https://www.jet.car/beta/";
    ...
    public static String driver_message_arrived_intent_action_pubunb = package_name + ".driver.message.action.pubnub";
    ...
    public static String iTripId = "iTripId";
}
