...
import car.jet.riderapp.BuildConfig;
...
public class Utils {
    ...
    public static final int OTHER_AREA_CLICKED_CODE = 146;
...
//**add this line**
        ...
        Utils.printLog("eTypeNotiFication", "::" + eType);
...
//**edit this line to put requestID as requestCode**
        ...
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            mBuilder.setLargeIcon(BitmapFactory.decodeResource(context.getResources(),
                    R.mipmap.ic_launcher));
            mBuilder.setContentTitle(title).setContentText(generalFunctions.getJsonValue("vTitle", message)).setContentIntent(contentIntent);
            mBuilder.setDefaults(Notification.DEFAULT_ALL).setAutoCancel(true);
            mBuilder.setColor(context.getResources().getColor(R.color.appThemeColor_1));
        } else {
            mBuilder.setSmallIcon(R.drawable.ic_stat_rider_logo);
    ...
    public static int getWidthOfBanner(Context mContext, int widthOffsetDpValueInPixel){
        return ((int) (Utils.getScreenPixelWidth(mContext) -  widthOffsetDpValueInPixel));
    }

    public static int getHeightOfBanner(Context mContext, int widthOffsetDpValueInPixel){
        return ((int) ((Utils.getWidthOfBanner(mContext, widthOffsetDpValueInPixel) / 1.77777778)));
    }
