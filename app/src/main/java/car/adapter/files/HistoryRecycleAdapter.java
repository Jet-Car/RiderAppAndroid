...
public class HistoryRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            if (item.get("APP_TYPE").equalsIgnoreCase("delivery") || item.get("APP_TYPE").equalsIgnoreCase(Utils.CabGeneralType_Deliver) || item.get("APP_TYPE").equalsIgnoreCase(Utils.CabGeneralType_Ride) || item.get("APP_TYPE").equalsIgnoreCase(Utils.CabGeneralType_UberX)) {
                ...
                Utils.printLog("eTypeCheck", "::" + item.get("eType"));
            ...
            if (item.get("SelectedCategory") != null && !item.get("SelectedCategory").equalsIgnoreCase("")) {
                ...
                if ((item.get("SelectedVehicle") != null && !(item.get("SelectedVehicle").equalsIgnoreCase("")))) {
                    ...
                    if (item.get("vPackageName") != null && !item.get("vPackageName").equalsIgnoreCase("")) {
                        viewHolder.SelectedTypeNameTxt.setText(generalFunc.retrieveLangLBl("", "LBL_RENTAL_CATEGORY_TXT") + "-" + item.get("SelectedCategory") + "-" + (item.get("SelectedVehicle")));
                    }
                } else {
                    viewHolder.SelectedTypeNameTxt.setText(item.get("SelectedCategory"));

                    if (item.get("vPackageName") != null && !item.get("vPackageName").equalsIgnoreCase("")) {
                        viewHolder.SelectedTypeNameTxt.setText(generalFunc.retrieveLangLBl("", "LBL_RENTAL_CATEGORY_TXT") + "-" + item.get("SelectedCategory"));
                    }
