...
import car.fragments.AddCardFragment;
import car.fragments.OrderDetailsFrag;
import car.fragments.PaymentFrag;
import car.fragments.ViewCardFragment;
...
public class BookingSummaryActivity extends AppCompatActivity {
    ...
    public void openViewOrderFrag() {
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.mainContent, orderDetailsFrag).commit();
    }
    ...
    public void openPaymentFrag() {
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.mainContent, paymentFrag).commit();
