...
public class RatingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        desdashImage = (ImageView) findViewById(R.id.desdashImage);
            ...
            public void setResponse(String responseString) {
                ...
                if (responseString != null && !responseString.equals("")) {
                    ...
                    if (isDataAvail == true) {
                        ...
                        btn_type2.setEnabled(true);
                        if (generalFunc.getJsonValue(CommonUtilities.message_str, responseString).equalsIgnoreCase("LBL_REQUIRED_MINIMUM_AMOUT")) {
                            generalFunc.showGeneralMessage("", generalFunc.retrieveLangLBl("", generalFunc.getJsonValue(CommonUtilities.message_str, responseString)) + " " + generalFunc.getJsonValue("minValue", responseString));
