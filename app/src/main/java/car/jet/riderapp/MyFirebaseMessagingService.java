                ...
                if (isJSONValid(message)) {
                    ...
                    if (!MyApp.getInstance().isMyAppInBackGround()) {
                        ...
                        if (generalFunc.getJsonValue("MsgType", remoteMessage.getData().get("message")).equals("TripEnd") ||
                            ...
                            Utils.generateNotificationForRating(getApplicationContext(),  remoteMessage.getData().get("message"), generalFunc.getJsonValue("iTripId", message));
                        } else {

                            Utils.printLog("VTitleNotification","::"+generalFunc.getJsonValue("vTitle", message));
